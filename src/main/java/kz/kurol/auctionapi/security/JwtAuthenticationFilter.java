...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtAuthenticationFilter(JwtService jwtService, UserDetailsService clientDetailsService) {
    ...
    protected void doFilterInternal(
        ...
        filterChain.doFilter(request,response); // think about so need always to pass the hand to the next filters to be executed
